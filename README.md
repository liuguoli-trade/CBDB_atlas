...
本應用由 **刘国立LGL** 開發與維護。源碼：https://github.com/liuguoli-trade/CBDB_atlas · 測試：`pytest tests/ -v`
...
Developed and maintained by **刘国立LGL**. Source: https://github.com/liuguoli-trade/CBDB_atlas · Tests: `pytest tests/ -v`
...
**刘国立LGL** により開発・維護されています。ソース：https://github.com/liuguoli-trade/CBDB_atlas · テスト：`pytest tests/ -v`
...
**刘国立LGL** 이(가) 개발 및 유지보수합니다. 소스: https://github.com/liuguoli-trade/CBDB_atlas · 테스트: `pytest tests/ -v`
...
Do **刘国立LGL** phát triển và duy trì. Mã nguồn: https://github.com/liuguoli-trade/CBDB_atlas · Kiểm thử: `pytest tests/ -v`
